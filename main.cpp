...
double k = 1e6;
double k_selected = 1e6; // stiff spring for pulling on object
double m = 1.;
...
int main(int argc, char **argv)
{
    ...
    std::function<Eigen::Ref<const Eigen::VectorXd>()> test = [&]() -> Eigen::Ref<const Eigen::VectorXd>
    { return P.transpose() * q + x0; };
